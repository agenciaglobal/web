...
export type SitePageContextNews = {
  node?: Maybe<SitePageContextNewsNode>;
};

export type SitePageContextNewsFilterInput = {
  node?: Maybe<SitePageContextNewsNodeFilterInput>;
};

export type SitePageContextNewsFilterListInput = {
  elemMatch?: Maybe<SitePageContextNewsFilterInput>;
};

export type SitePageContextNewsNode = {
  fields?: Maybe<SitePageContextNewsNodeFields>;
  frontmatter?: Maybe<SitePageContextNewsNodeFrontmatter>;
};

export type SitePageContextNewsNodeFields = {
  slug?: Maybe<Scalars['String']>;
};

export type SitePageContextNewsNodeFieldsFilterInput = {
  slug?: Maybe<StringQueryOperatorInput>;
};

export type SitePageContextNewsNodeFilterInput = {
  fields?: Maybe<SitePageContextNewsNodeFieldsFilterInput>;
  frontmatter?: Maybe<SitePageContextNewsNodeFrontmatterFilterInput>;
};
...
export type SitePageContextNewsNodeFrontmatterFilterInput = {
...
export type SitePageFieldsEnum = 
  ...
  | 'context___previous___frontmatter___type'
...
export type NewsQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: (
    ...
    & { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'title' | 'description' | 'image' | 'type'>> }
      ) }> }
  ) };
...
export type TeamQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: (
    ...
    & { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'name' | 'job' | 'image' | 'black_image'>> }
      ) }> }
  ) };
...
export type NewsPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }>, mdx?: Maybe<(
    ...
    & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'tags' | 'date' | 'description' | 'text_1' | 'text_2' | 'image'>> }
  )> };
...
export type PortifolioPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }>, mdx?: Maybe<(
    Pick<Mdx, 'id' | 'excerpt' | 'body'>
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'author' | 'description' | 'image' | 'image_1' | 'image_2' | 'image_3' | 'text_1' | 'text_2' | 'text_3' | 'text_4' | 'youtube'>> }
  )> };
