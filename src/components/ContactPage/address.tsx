import { Typography, Hidden, makeStyles, SvgIcon, Theme } from "@material-ui/core"
    ...
    >
      ...
      <Box className={classes.style}>
        <Box style={{ paddingTop: 32, paddingBottom: 32 }}>
          <Typography className={classes.font}>Rua Câncio Gomes, 609</Typography>
          <Typography className={classes.font}>Fábrica do Futuro</Typography>
          <Typography className={classes.font}>Porto Alegre, RS, Brasil</Typography>
